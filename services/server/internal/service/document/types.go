...
type WorkspaceDocumentResourceImage = model.WorkspaceDocumentResourceImage
...
type WorkspaceDocumentSectionImageRequest = model.WorkspaceDocumentSectionImageRequest
type WorkspaceSectionImage = model.WorkspaceSectionImage
type WorkspaceDocumentSectionMediaRequest = model.WorkspaceDocumentSectionMediaRequest
