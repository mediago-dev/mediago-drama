...
项目内置多类提示词资产，覆盖 Agent 规范、工具使用、核心文档规则、角色图、场景图和视频镜头生成。Agent 指令与核心文档规则由官方指令单独管理，提示词包只分发 Skills 与可复用提示词；文档识别规则不依赖 Skill，避免用户修改 Skill 后破坏软件识别边界。
...
| 核心文档规则 | `packages/instructions/pkg/official/assets/instructions/DOCUMENT_RULES.md` | 文档分类、二级标题资源边界和 section-id 规则，运行时注入且不可在设置中编辑 |
