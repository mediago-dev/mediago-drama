...
内置 Skills 位于 `services/server/configs/skills/builtin/`，服务端会作为默认能力加载。
...
| 类型 | 路径 | 内容 |
| --- | --- | --- |
| Agent 模板 | `services/server/configs/templates/prompts/AGENTS.md` | 创作工作区中的 Agent 行为约束 |
| 工具模板 | `services/server/configs/templates/prompts/TOOLS.md` | 长文档写入、分批编辑、文档分类等工具调用规则 |
| 提示词库 | `services/server/configs/prompt-library/builtin/` | 角色概念图、多视图、场景氛围图、四视图、电影感镜头等 |
| 风格预设 | `services/server/configs/style-presets/builtin/` | 真人写实、2D 动漫、3DCG 动漫、Q 版风格 |
