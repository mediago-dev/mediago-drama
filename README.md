...
| 类型 | 路径 | 内容 |
| --- | --- | --- |
| Agent 指令 | `packages/instructions/pkg/pack/builtin/assets/instructions/AGENTS.md` | 创作工作区中的 Agent 行为约束 |
| 工具指令 | `packages/instructions/pkg/pack/builtin/assets/instructions/TOOLS.md` | 长文档写入、分批编辑、文档分类等工具调用规则 |
