...
// One-time Ed25519 keypair generation for application-bundle hot updates.
//
...
//   2. Paste the PUBLIC key into bundleUpdatePublicKey in
...
console.log("PUBLIC key (paste into electron/src/hot-update-config.ts bundleUpdatePublicKey):\n");
