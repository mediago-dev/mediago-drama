...
import {
	...
	libTVGPTImageParams,
	libTVNanoBananaParams,
	libTVSeedreamParams,
	libTVSeedanceParams,
	libTVSeedanceStandardParams,
	mediagoChatImageParams,
	mediagoGPTImageParamCombos,
	mediagoGPTImageParams,
	mediagoNanoBanana25ParamCombos,
	mediagoNanoBanana25Params,
	mediagoNanoBanana31ParamCombos,
	mediagoNanoBanana31Params,
	mediagoNanoBananaProParamCombos,
	mediagoNanoBananaProParams,
	minimaxSpeechParams,
	nanoParamCombos,
	nanoParams,
	officialGPTImageParams,
	officialNanoBanana25ParamCombos,
	officialNanoBanana25Params,
	officialSeedanceParams,
	openRouterImageParams,
	openRouterVideoParams,
	pippitSeedanceParams,
	pippitSeedanceStandardParams,
	plannedRoute,
	route,
	seedreamParamCombos,
	seedreamParams,
...
export const fallbackCatalog: GenerationModelsResponse = {
	...
	routes: [
		...
		route(
			...
			"https://doc.dmxapi.cn/gpt-image-2-text-to-image.html",
			dmxGPTImageParams(),
			false,
			true,
			"gpt-image-2",
		...
		route(
			"mediago.gemini-3.1-flash-image",
			"nano-banana",
			"gemini-3.1-flash-image-preview",
			"MediaGo",
			"image",
		...
		route(
			"libtv.gemini-3.1-flash-image-preview",
			"nano-banana",
			"gemini-3.1-flash-image-preview",
			"LibTV",
			"image",
		...
		route(
			...
			"pippit.cli.video",
			"https://github.com/Pippit-dev/cli",
			pippitSeedanceParams(),
			true,
			true,
		),
		...
		route(
			...
			true,
			true,
			"xiaoyunque-seedance-2-mini-lite",
		),
		route(
	...
	providers: [
		...
		{ id: "mediago", label: "MediaGo", providerType: "aggregator" },
