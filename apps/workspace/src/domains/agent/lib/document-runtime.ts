...
三十岁左右女性，城市悬疑题材女主。浅麦色肤色，鹅蛋脸，黑色齐肩短发，眼神冷静警觉；中等身高，身形清瘦，肩背挺直，行动克制利落。

深色风衣搭配灰黑内搭和磨旧牛仔裤，整体造型低调实用。旧相机斜挎在身侧，右手银色戒指和随身黑色录音笔是跨镜头保持一致的识别细节。`,
		};
	}
...
深夜暴雨后的海边废弃工业厂房，空间包含空旷装配大厅、地下仓库、控制室与狭窄通道。破损天窗漏入冷色月光，远处海雾压低能见度，积水地面反射锈蚀传送带、断裂梁柱、半开的资料柜和编号 03:17 的巡检表，控制室碎玻璃与褪色墙面标语隐在后景里，整体氛围压抑、阴冷、危险感强。

Prompt：不能出现其他人, 无人, 纯场景, 深夜暴雨后的废弃临海旧厂房，冷色月光从破损天窗落入空旷装配大厅，积水地面反射锈蚀传送带、断裂梁柱、半开的资料柜、编号 03:17 的巡检表，远处控制室碎玻璃与褪色墙面标语隐在海雾中，压抑阴冷的工业废墟氛围，横向16:9电影级场景设定图，极高画质，极致细节，无字幕，无水印，无UI，no humans, empty, landscape only`,
		};
	}
