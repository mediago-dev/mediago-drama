...
var familySpecs = []familySpec{
	...
	},
	{
		...
		Routes: []ModelRoute{
			...
			dmxRoute(RouteDMXGPT55Text, FamilyText, VersionGPT55Text, "DMX", "gpt-5.5", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXGPT54Text, FamilyText, VersionGPT54Text, "DMX", "gpt-5.4", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXGPT54MiniText, FamilyText, VersionGPT54MiniText, "DMX", "gpt-5.4-mini", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXGemini35FlashText, FamilyText, VersionGemini35FlashText, "DMX", "gemini-3.5-flash", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXGemini31ProText, FamilyText, VersionGemini31ProText, "DMX", "gemini-3.1-pro-preview", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXGemini31FlashLiteText, FamilyText, VersionGemini31FlashLiteText, "DMX", "gemini-3.1-flash-lite", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXMiniMaxM3Text, FamilyText, VersionMiniMaxM3Text, "DMX", "MiniMax-M3", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXMiniMaxM27Text, FamilyText, VersionMiniMaxM27Text, "DMX", "MiniMax-M2.7", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXMiniMaxM27HighspeedText, FamilyText, VersionMiniMaxM27HighspeedText, "DMX", "MiniMax-M2.7-highspeed", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXDeepSeekV4FlashText, FamilyText, VersionDeepSeekV4FlashText, "DMX", "deepseek-v4-flash", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
			dmxRoute(RouteDMXDeepSeekV4ProText, FamilyText, VersionDeepSeekV4ProText, "DMX", "deepseek-v4-pro", AdapterDMXChatText, dmxChatDocs, textParams(), false, false, ""),
