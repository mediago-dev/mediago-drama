...
var familySpecs = []familySpec{
	...
	},
	{
		...
		Routes: []ModelRoute{
			...
			mediagoRoute(RouteMediagoNanoBanana31, FamilyNanoBanana, VersionNanoBanana31, KindImage, "MediaGo", "gemini-3.1-flash-image", AdapterOpenRouterImages, openRouterImageDocs, mediagoGPTImageParams(), false, true),
